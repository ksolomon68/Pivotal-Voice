...
async function getTopics() {
    ...
    if (error || !data || data.length === 0) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forum$2f$forum$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEED_TOPICS"];
    }
...
async function getTopicsByCategory(categoryId) {
    ...
    if (!data || data.length === 0) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forum$2f$forum$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEED_TOPICS"].filter((t)=>t.categoryId === categoryId);
    }
    return data.map(mapTopic);
}
...
async function getRepliesByTopic(topicId) {
    ...
    if (!data || data.length === 0) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forum$2f$forum$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEED_REPLIES"].filter((r)=>r.topicId === topicId);
    }
...
async function getForumStats() {
    ...
    if (!topicCount && !replyCount && !userCount) {
        return {
            totalTopics: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forum$2f$forum$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEED_TOPICS"].length,
            totalReplies: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forum$2f$forum$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEED_REPLIES"].length,
            totalUsers: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forum$2f$forum$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEED_USERS"].length,
            activeToday: Math.min(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forum$2f$forum$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEED_USERS"].length, 14)
        };
    }
    return {
...
async function getCivicEvents() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('civic_events').select('*, event_rsvps(user_id)').order('date', {
        ascending: true
    }).order('start_time', {
        ascending: true
    });
    ...
    const allEvents = [
        ...dbEvents,
        ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$events$2f$civic$2d$events$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOCAL_MEETUP_EVENTS"]
    ];
...
_s(ForumSidebar, "+Cn3kGNr06PNeGqVwWDDPMYaEcQ=");
_c = ForumSidebar;
var _c;
...
function AuthModal({ isOpen, onClose, initialTab = 'login' }) {
    _s();
    const { login, register } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forum$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(AuthModal, "Gm2TX7jYP7UNGWTgMCZxzE9IuuE=", false, function() {
    return [
...
_s(NewTopicForm, "Eoomjdjg/TMVp7fiQHxKq3QH3d0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forum$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
function ForumPage() {
    ...
    const [filteredTopics, setFilteredTopics] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
...
_s(ForumPage, "zJiv9PQzRhp9Eyum9ST/8X0JbHU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forum$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=_54425e12._.js.map