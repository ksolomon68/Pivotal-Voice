...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            }["AuthProvider.useEffect.timeout"], 8000);
            const buildUser = {
                "AuthProvider.useEffect.buildUser": (profile)=>({
                        id: profile.id,
                        email: profile.email,
            ...
            }["AuthProvider.useEffect.buildUser"];
            const syncSession = {
                "AuthProvider.useEffect.syncSession": async ()=>{
                    try {
                        const { data: { session }, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                        if (error) {
    ...
    const resetPassword = async (email)=>{
        const redirectTo = ("TURBOPACK compile-time truthy", 1) ? `${window.location.origin}/reset-password` : "TURBOPACK unreachable";
...
_s(AuthProvider, "ipMMTf6yjOQfC1wH6Pf4lbU2fEA=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
function ClientWrappers() {
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientWrappers.useEffect": ()=>{
            const handleUnhandledRejection = {
                "ClientWrappers.useEffect.handleUnhandledRejection": (event)=>{
            ...
            }["ClientWrappers.useEffect.handleUnhandledRejection"];
            window.addEventListener('unhandledrejection', handleUnhandledRejection);
            return ({
                "ClientWrappers.useEffect": ()=>window.removeEventListener('unhandledrejection', handleUnhandledRejection)
            })["ClientWrappers.useEffect"];
        }
    }["ClientWrappers.useEffect"], []);
...
_s(ClientWrappers, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c1 = ClientWrappers;
var _c, _c1;
