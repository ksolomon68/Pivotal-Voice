...
"[project]/lib/broadcast/broadcast-service.ts [app-route] (ecmascript, async loader)", ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/node_modules_0e08275e._.js",
  "server/chunks/lib_9b2236e6._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[project]/lib/broadcast/broadcast-service.ts [app-route] (ecmascript)");
    });
});
}),
];