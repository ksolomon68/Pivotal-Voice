...
"[project]/lib/events/civic-events-data.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/civic-events/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$events$2f$civic$2d$events$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/events/civic-events-data.ts [app-route] (ecmascript)");
;
;
;
const dynamic = 'force-dynamic'; // always fetch live from Supabase
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(("TURBOPACK compile-time value", "https://cndaaiaygxhmuvqtgxhk.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNuZGFhaWF5Z3hobXV2cXRneGhrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA2OTQyMzMsImV4cCI6MjA4NjI3MDIzM30.a0gw6nI_sBsR8GN0O14rwzNwXOa4XK6sg60mooySmwE"));
...
async function GET() {
    try {
        const { data, error } = await supabase.from('civic_events').select('*, event_rsvps(user_id)').eq('approval_status', 'approved').order('date', {
            ascending: true
        }).order('start_time', {
            ascending: true
        });
        ...
        const seedOnly = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$events$2f$civic$2d$events$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SEED_CIVIC_EVENTS"].filter((e)=>!dbKeys.has(`${e.title}|${e.date}`));
        const merged = [
            ...dbEvents,
            ...seedOnly
        ].sort((a, b)=>{
        ...
        const sorted = [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$events$2f$civic$2d$events$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SEED_CIVIC_EVENTS"]
        ].sort((a, b)=>{
            const da = new Date(`${a.date}T${a.startTime}`).getTime();
            const db2 = new Date(`${b.date}T${b.startTime}`).getTime();
            return da - db2;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4fff231e._.js.map