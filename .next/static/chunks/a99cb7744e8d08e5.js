(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,50036,e=>{"use strict";var t=e.i(43476),o=e.i(93983),a=e.i(87392),i=e.i(10980),s=e.i(33651),n=e.i(78583),r=e.i(78716),l=e.i(78917),c=e.i(61911),d=e.i(75254);let u=(0,d.default)("Mic2",[["path",{d:"m12 8-9.04 9.06a2.82 2.82 0 1 0 3.98 3.98L16 12",key:"zoua8r"}],["circle",{cx:"17",cy:"7",r:"5",key:"1fomce"}]]);var m=e.i(98919),h=e.i(33553),p=e.i(79334),g=e.i(70273),y=e.i(63059),f=e.i(31091);let b=(0,d.default)("BarChart2",[["line",{x1:"18",x2:"18",y1:"20",y2:"10",key:"1xfpm4"}],["line",{x1:"12",x2:"12",y1:"20",y2:"4",key:"be30l9"}],["line",{x1:"6",x2:"6",y1:"20",y2:"14",key:"1r4le6"}]]);var w=e.i(5631),v=e.i(37727),x=e.i(14764);let k=(0,d.default)("Play",[["polygon",{points:"5 3 19 12 5 21 5 3",key:"191637"}]]);var C=e.i(46932),T=e.i(88653),N=e.i(71645),A=e.i(22016);let j=[{id:1,slug:"ellis-county-voter-guide-2026",title:"Ellis County Voter Guide 2026",description:"Full breakdown of every race and proposition on the Ellis County ballot — candidates, positions, and what each measure means for your community.",type:"PDF",category:"Voter Information",audience:["Voters"],featured:!0,downloads:342,tags:["Ellis County","2026 Election","Ballot Guide"],content:`## What's on the Ballot
...
If you don't know the answer: *"That's an important question and I want to give you an accurate answer — let me follow up with you directly. Can I get your contact information after?"*`}],E=[{label:"Voter Information",icon:h.Vote,description:"Registration deadlines, polling locations, ballot breakdowns, and rights.",audience:"Voters"},{label:"Candidate Toolkit",icon:f.Megaphone,description:"Campaign planning, filing requirements, FEC compliance, and messaging guides.",audience:"Candidates"},{label:"Media Relations",icon:p.Newspaper,description:"Press release templates, interview prep, and newsroom contact strategies.",audience:"All"},{label:"Public Speaking",icon:u,description:"Debate coaching, town hall facilitation, and speech structure frameworks.",audience:"All"},{label:"Civic Engagement",icon:c.Users,description:"Guides to attending public meetings, submitting comments, and organizing.",audience:"Voters"},{label:"Government Transparency",icon:m.Shield,description:"Open records requests, FOIA templates, and public accountability tools.",audience:"Voters"},{label:"Campaign Strategy",icon:b,description:"Polling interpretation, opposition research basics, and digital outreach.",audience:"Candidates"},{label:"Crisis & Reputation",icon:w.CheckCircle,description:"Rapid response playbooks, crisis messaging, and reputation management.",audience:"Candidates"}],P={All:"bg-cream/10 text-cream/80",Voters:"bg-blue-500/20 text-blue-300",Candidates:"bg-gold/20 text-gold"};function S({resource:e,onClose:o}){let[a,i]=(0,N.useState)(""),[n,r]=(0,N.useState)(!1),[l,c]=(0,N.useState)(!1),d=async t=>{if(t.preventDefault(),a){c(!0);try{let t=await fetch("/api/send-resource",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:a,resourceTitle:e.title,resourceCategory:e.category,resourceType:e.type,resourceSlug:e.slug})});if(!t.ok){let e=await t.json().catch(()=>({}));throw console.error("send-resource error status:",t.status,"body:",e),Error(e.error||e.detail?.message||"Send failed")}r(!0)}catch(t){let e=t instanceof Error?t.message:"Unknown error";alert(`Something went wrong: ${e}`)}finally{c(!1)}}};return(0,t.jsxs)("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4",children:[(0,t.jsx)("div",{className:"absolute inset-0 bg-black/70 backdrop-blur-sm",onClick:o}),(0,t.jsxs)(C.motion.div,{initial:{opacity:0,scale:.95,y:10},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:10},transition:{duration:.2},className:"relative bg-navy border border-gold/30 rounded-2xl p-8 w-full max-w-md shadow-2xl",children:[(0,t.jsx)("button",{onClick:o,className:"absolute top-4 right-4 text-cream/40 hover:text-cream transition-colors",children:(0,t.jsx)(v.X,{className:"w-5 h-5"})}),n?(0,t.jsxs)("div",{className:"text-center py-4",children:[(0,t.jsx)("div",{className:"w-14 h-14 bg-green-500/15 border border-green-500/30 rounded-full flex items-center justify-center mx-auto mb-4",children:(0,t.jsx)(w.CheckCircle,{className:"w-7 h-7 text-green-400"})}),(0,t.jsx)("h3",{className:"font-display text-lg font-semibold text-white mb-2",children:"Check your inbox!"}),(0,t.jsxs)("p",{className:"text-cream/60 text-sm mb-4",children:["We sent a direct link to ",(0,t.jsx)("span",{className:"text-white",children:a}),"."]}),(0,t.jsx)(A.default,{href:`/resources/${e.slug}`,className:"btn-primary text-sm inline-block mb-3",onClick:o,children:"Read It Now →"}),(0,t.jsx)("br",{}),(0,t.jsx)("button",{onClick:o,className:"btn-secondary text-sm",children:"Back to Resources"})]}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("div",{className:"w-12 h-12 bg-gold/10 border border-gold/30 rounded-xl flex items-center justify-center mb-4",children:"Video"===e.type?(0,t.jsx)(k,{className:"w-6 h-6 text-gold"}):(0,t.jsx)(s.Download,{className:"w-6 h-6 text-gold"})}),(0,t.jsx)("h3",{className:"font-display text-lg font-semibold text-white mb-1",children:"Video"===e.type?"Watch This Resource":"Get This Resource"}),(0,t.jsx)("p",{className:"text-gold/70 text-xs font-medium uppercase tracking-wide mb-2",children:e.category}),(0,t.jsxs)("p",{className:"text-cream/60 text-sm mb-6",children:[e.title," — enter your email and we'll send a direct link straight to your inbox."]}),(0,t.jsxs)("form",{onSubmit:d,className:"space-y-3",children:[(0,t.jsx)("input",{type:"email",required:!0,value:a,onChange:e=>i(e.target.value),placeholder:"your@email.com",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-3 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors"}),(0,t.jsx)("button",{type:"submit",disabled:l,className:"btn-primary w-full flex items-center justify-center gap-2",children:l?(0,t.jsx)("span",{className:"animate-pulse",children:"Sending…"}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(x.Send,{className:"w-4 h-4"})," Send to My Inbox"]})})]}),(0,t.jsx)("p",{className:"text-cream/30 text-xs text-center mt-4",children:"No spam. Unsubscribe anytime."})]})]})]})}function D({onClose:e}){let[o,a]=(0,N.useState)(""),[i,s]=(0,N.useState)(""),[n,r]=(0,N.useState)(""),[l,c]=(0,N.useState)(""),[d,u]=(0,N.useState)(""),[m,h]=(0,N.useState)(!1),[p,g]=(0,N.useState)(!1),y=async e=>{if(e.preventDefault(),i&&n&&l){g(!0);try{let e=await fetch("/api/submit-resource",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:o,email:i,title:n,description:l,link:d})});if(!e.ok){let t=await e.json().catch(()=>({}));throw console.error("submit-resource error status:",e.status,"body:",t),Error(t.error||"Submission failed")}h(!0)}catch(t){let e=t instanceof Error?t.message:"Unknown error";alert(`Something went wrong: ${e}`)}finally{g(!1)}}};return(0,t.jsxs)("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4",children:[(0,t.jsx)("div",{className:"absolute inset-0 bg-black/70 backdrop-blur-sm",onClick:e}),(0,t.jsxs)(C.motion.div,{initial:{opacity:0,scale:.95,y:10},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:10},transition:{duration:.2},className:"relative bg-navy border border-gold/30 rounded-2xl p-8 w-full max-w-lg shadow-2xl overflow-y-auto max-h-[90vh]",children:[(0,t.jsx)("button",{onClick:e,className:"absolute top-4 right-4 text-cream/40 hover:text-cream transition-colors",children:(0,t.jsx)(v.X,{className:"w-5 h-5"})}),m?(0,t.jsxs)("div",{className:"text-center py-6",children:[(0,t.jsx)("div",{className:"w-14 h-14 bg-green-500/15 border border-green-500/30 rounded-full flex items-center justify-center mx-auto mb-4",children:(0,t.jsx)(w.CheckCircle,{className:"w-7 h-7 text-green-400"})}),(0,t.jsx)("h3",{className:"font-display text-lg font-semibold text-white mb-2",children:"Thank you!"}),(0,t.jsx)("p",{className:"text-cream/60 text-sm mb-6",children:"Your resource suggestion has been submitted to the Pivotal Voice team. We will review it shortly."}),(0,t.jsx)("button",{onClick:e,className:"btn-primary text-sm",children:"Close"})]}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("div",{className:"w-12 h-12 bg-gold/10 border border-gold/30 rounded-xl flex items-center justify-center mb-4",children:(0,t.jsx)(x.Send,{className:"w-6 h-6 text-gold"})}),(0,t.jsx)("h3",{className:"font-display text-lg font-semibold text-white mb-1",children:"Submit a Resource"}),(0,t.jsx)("p",{className:"text-cream/60 text-sm mb-6",children:"Share a guide, template, or tool with the Pivotal Voice community."}),(0,t.jsxs)("form",{onSubmit:y,className:"space-y-4",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-cream/80 text-xs font-semibold uppercase tracking-wider mb-1.5",children:"Your Name"}),(0,t.jsx)("input",{type:"text",value:o,onChange:e=>a(e.target.value),placeholder:"Jane Doe",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-2.5 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors"})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-cream/80 text-xs font-semibold uppercase tracking-wider mb-1.5",children:"Your Email *"}),(0,t.jsx)("input",{type:"email",required:!0,value:i,onChange:e=>s(e.target.value),placeholder:"your@email.com",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-2.5 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors"})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-cream/80 text-xs font-semibold uppercase tracking-wider mb-1.5",children:"Resource Title *"}),(0,t.jsx)("input",{type:"text",required:!0,value:n,onChange:e=>r(e.target.value),placeholder:"e.g. Ellis County Campaign Checklist",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-2.5 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors"})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-cream/80 text-xs font-semibold uppercase tracking-wider mb-1.5",children:"Link / Source URL (Optional)"}),(0,t.jsx)("input",{type:"url",value:d,onChange:e=>u(e.target.value),placeholder:"https://example.com/resource",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-2.5 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors"})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-cream/80 text-xs font-semibold uppercase tracking-wider mb-1.5",children:"Description / Content *"}),(0,t.jsx)("textarea",{required:!0,rows:4,value:l,onChange:e=>c(e.target.value),placeholder:"Describe the resource or paste its text here...",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-2.5 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors resize-none"})]}),(0,t.jsx)("button",{type:"submit",disabled:p,className:"btn-primary w-full flex items-center justify-center gap-2 mt-2",children:p?(0,t.jsx)("span",{className:"animate-pulse",children:"Submitting…"}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(x.Send,{className:"w-4 h-4"})," Submit for Review"]})})]})]})]})]})}function I(){let[e,c]=(0,N.useState)("All"),[d,u]=(0,N.useState)("All"),[m,h]=(0,N.useState)(null),[p,f]=(0,N.useState)(!1),b=j.filter(t=>{let o="All"===e||t.audience.includes(e)||t.audience.includes("All"),a="All"===d||t.category===d;return o&&a}),v=j.filter(e=>e.featured),x="All"===e?E:E.filter(t=>t.audience===e||"All"===t.audience),k=({resource:e,index:o})=>{var a;let i="Video"===(a=e.type)?r.Video:"Template"===a?n.FileText:"Checklist"===a?w.CheckCircle:n.FileText;return(0,t.jsxs)(C.motion.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.4,delay:Math.min(.05*o,.4)},className:"card group hover:border-gold/40 flex flex-col",children:[(0,t.jsxs)("div",{className:"flex items-start justify-between mb-3",children:[(0,t.jsx)("div",{className:"w-10 h-10 bg-gold/10 border border-gold/20 rounded-lg flex items-center justify-center",children:(0,t.jsx)(i,{className:"w-5 h-5 text-gold"})}),(0,t.jsx)("div",{className:"flex gap-1 flex-wrap justify-end",children:e.audience.filter(e=>"All"!==e).map(e=>(0,t.jsx)("span",{className:`text-xs px-2 py-0.5 rounded-full font-medium ${P[e]}`,children:e},e))})]}),(0,t.jsx)("span",{className:"text-gold/60 text-xs font-medium uppercase tracking-wide",children:e.category}),(0,t.jsx)(A.default,{href:`/resources/${e.slug}`,className:"mt-1 mb-2 flex-1",children:(0,t.jsx)("h3",{className:"font-display text-base font-semibold text-white group-hover:text-gold transition-colors leading-snug",children:e.title})}),(0,t.jsx)("p",{className:"text-cream/60 text-sm mb-4 line-clamp-3",children:e.description}),(0,t.jsx)("div",{className:"flex flex-wrap gap-1 mb-4",children:e.tags.slice(0,3).map(e=>(0,t.jsx)("span",{className:"text-xs bg-navy-dark/80 text-cream/40 px-2 py-0.5 rounded",children:e},e))}),(0,t.jsxs)("div",{className:"flex items-center justify-between pt-3 border-t border-gold/10 mt-auto",children:[(0,t.jsxs)("span",{className:"text-cream/40 text-xs",children:[e.downloads.toLocaleString()," downloads"]}),(0,t.jsxs)("button",{onClick:()=>h(e),className:"btn-secondary text-xs flex items-center gap-1.5 py-1.5 px-3",children:[(0,t.jsx)(s.Download,{className:"w-3.5 h-3.5"}),"Video"===e.type?"Watch":"Get"]})]})]},e.id)};return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(T.AnimatePresence,{children:[m&&(0,t.jsx)(S,{resource:m,onClose:()=>h(null)}),p&&(0,t.jsx)(D,{onClose:()=>f(!1)})]}),(0,t.jsx)(o.default,{}),(0,t.jsxs)("main",{className:"min-h-screen",children:[(0,t.jsxs)("section",{className:"relative bg-gradient-to-b from-navy via-navy to-navy-dark border-b border-gold/15 py-20 overflow-hidden",children:[(0,t.jsx)("div",{className:"absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(212,175,55,0.06)_0%,_transparent_60%)]"}),(0,t.jsx)("div",{className:"container-custom relative z-10",children:(0,t.jsxs)("div",{className:"text-center max-w-3xl mx-auto",children:[(0,t.jsx)("div",{className:"w-16 h-16 bg-gold/10 border border-gold/20 rounded-2xl flex items-center justify-center mx-auto mb-5",children:(0,t.jsx)(i.BookOpen,{className:"w-8 h-8 text-gold"})}),(0,t.jsx)("h1",{className:"text-hero font-bold text-white mb-4",children:"Resource Library"}),(0,t.jsx)("p",{className:"text-lg text-cream/60 mb-8",children:"Guides, templates, and tools built by political communications professionals — for voters who want to engage and candidates who want to win."}),(0,t.jsx)("div",{className:"inline-flex bg-navy-dark/60 border border-gold/20 rounded-xl p-1 gap-1",children:["All","Voters","Candidates"].map(o=>(0,t.jsx)("button",{onClick:()=>{c(o),u("All")},className:`px-5 py-2 rounded-lg text-sm font-semibold transition-all ${e===o?"bg-gold text-navy":"text-cream/60 hover:text-white"}`,children:"All"===o?"All Resources":`For ${o}`},o))})]})})]}),(0,t.jsx)("section",{className:"bg-navy-dark/80 border-b border-gold/10 py-6",children:(0,t.jsx)("div",{className:"container-custom",children:(0,t.jsxs)("div",{className:"grid grid-cols-3 gap-6 text-center",children:[(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"text-2xl font-bold text-gold",children:[j.length,"+"]}),(0,t.jsx)("div",{className:"text-cream/50 text-sm mt-1",children:"Free Resources"})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("div",{className:"text-2xl font-bold text-gold",children:"8"}),(0,t.jsx)("div",{className:"text-cream/50 text-sm mt-1",children:"Categories"})]}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"text-2xl font-bold text-gold",children:[j.reduce((e,t)=>e+t.downloads,0).toLocaleString(),"+"]}),(0,t.jsx)("div",{className:"text-cream/50 text-sm mt-1",children:"Total Downloads"})]})]})})}),"All"===e&&"All"===d&&(0,t.jsx)("section",{className:"section bg-navy-dark/30",children:(0,t.jsxs)("div",{className:"container-custom",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 mb-8",children:[(0,t.jsx)(g.Star,{className:"w-5 h-5 text-gold"}),(0,t.jsx)("h2",{className:"text-section font-bold text-white",children:"Featured Resources"})]}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:v.map((e,o)=>(0,t.jsx)(k,{resource:e,index:o},e.id))})]})}),(0,t.jsx)("section",{className:"section bg-navy-dark/50",children:(0,t.jsxs)("div",{className:"container-custom",children:[(0,t.jsx)("h2",{className:"text-section font-bold text-white mb-8",children:"Browse by Category"}),(0,t.jsxs)("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10",children:[(0,t.jsxs)(C.motion.button,{onClick:()=>u("All"),className:`card text-left group transition-all ${"All"===d?"border-gold/60 bg-gold/5":""}`,children:[(0,t.jsx)("h3",{className:`font-semibold transition-colors ${"All"===d?"text-gold":"text-white group-hover:text-gold"}`,children:"All Categories"}),(0,t.jsxs)("p",{className:"text-cream/40 text-xs mt-1",children:[b.length," resources"]})]}),x.map((o,a)=>{let i=o.icon,s=j.filter(t=>t.category===o.label&&("All"===e||t.audience.includes(e)||t.audience.includes("All"))).length;return(0,t.jsxs)(C.motion.button,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.4,delay:.04*a},onClick:()=>u(o.label),className:`card text-left group transition-all ${d===o.label?"border-gold/60 bg-gold/5":""}`,children:[(0,t.jsxs)("div",{className:"flex items-start gap-3",children:[(0,t.jsx)("div",{className:"w-8 h-8 bg-gold/10 rounded-lg flex items-center justify-center shrink-0 mt-0.5",children:(0,t.jsx)(i,{className:"w-4 h-4 text-gold"})}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h3",{className:`font-semibold text-sm transition-colors ${d===o.label?"text-gold":"text-white group-hover:text-gold"}`,children:o.label}),(0,t.jsxs)("p",{className:"text-cream/40 text-xs mt-0.5",children:[s," resources"]})]})]}),(0,t.jsx)("p",{className:"text-cream/50 text-xs mt-3 leading-relaxed",children:o.description})]},o.label)})]})]})}),(0,t.jsx)("section",{className:"section",children:(0,t.jsxs)("div",{className:"container-custom",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-6",children:[(0,t.jsx)("h2",{className:"text-section font-bold text-white",children:"All"===d?"All Resources":d}),(0,t.jsxs)("span",{className:"text-cream/40 text-sm",children:[b.length," results"]})]}),0===b.length?(0,t.jsx)("div",{className:"text-center py-16 text-cream/40",children:"No resources found for this filter combination."}):(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6",children:b.map((e,o)=>(0,t.jsx)(k,{resource:e,index:o},e.id))})]})}),(0,t.jsx)("section",{className:"section bg-navy-dark/60 border-y border-gold/10",children:(0,t.jsx)("div",{className:"container-custom",children:(0,t.jsxs)("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-12 items-center",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("span",{className:"badge-gold text-xs mb-4 inline-block",children:"Pivotal Voice Services"}),(0,t.jsx)("h2",{className:"text-section font-bold text-white mb-4",children:"Need More Than a Template?"}),(0,t.jsx)("p",{className:"text-cream/70 mb-6",children:"These resources are a starting point. Pivotal Voice's communications professionals work directly with candidates and civic leaders — building custom messaging strategy, managing press relations, and guiding you through every stage of your campaign or issue."}),(0,t.jsx)("ul",{className:"space-y-3 mb-8",children:["Custom campaign messaging & brand development","Full-service media relations & press outreach","Crisis communications & reputation management","Debate prep & executive media coaching","Digital strategy & content production"].map(e=>(0,t.jsxs)("li",{className:"flex items-start gap-3 text-cream/80 text-sm",children:[(0,t.jsx)(y.ChevronRight,{className:"w-4 h-4 text-gold mt-0.5 shrink-0"}),e]},e))}),(0,t.jsxs)("div",{className:"flex gap-4",children:[(0,t.jsx)(A.default,{href:"/services#book",className:"btn-primary inline-flex items-center justify-center",children:"Schedule a Consultation"}),(0,t.jsxs)(A.default,{href:"/services",className:"btn-secondary inline-flex items-center gap-2",children:[(0,t.jsx)(l.ExternalLink,{className:"w-4 h-4"}),"View Services"]})]})]}),(0,t.jsx)("div",{className:"grid grid-cols-2 gap-4",children:[{label:"Campaigns Supported",value:"50+"},{label:"Media Placements",value:"300+"},{label:"Years in Ellis County",value:"12+"},{label:"Candidate Win Rate",value:"74%"}].map(e=>(0,t.jsxs)("div",{className:"card text-center",children:[(0,t.jsx)("div",{className:"text-3xl font-bold text-gold mb-1",children:e.value}),(0,t.jsx)("div",{className:"text-cream/50 text-sm",children:e.label})]},e.label))})]})})}),(0,t.jsx)("section",{className:"bg-navy py-16",children:(0,t.jsx)("div",{className:"container-custom",children:(0,t.jsxs)("div",{className:"text-center max-w-2xl mx-auto",children:[(0,t.jsx)("h2",{className:"text-section font-bold text-white mb-4",children:"Share a Resource"}),(0,t.jsx)("p",{className:"text-cream/70 mb-6",children:"Have a guide, template, or tool that would help Ellis County voters or candidates? Submit it for review and we'll add it to the library."}),(0,t.jsx)("button",{onClick:()=>f(!0),className:"btn-primary",children:"Submit a Resource"})]})})})]}),(0,t.jsx)(a.default,{})]})}e.s(["default",()=>I],50036)}]);