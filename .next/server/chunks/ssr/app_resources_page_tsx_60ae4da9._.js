module.exports=[42714,a=>{"use strict";var b=a.i(87924),c=a.i(81631),d=a.i(7710),e=a.i(53722),f=a.i(84505),g=a.i(4720),h=a.i(64791),i=a.i(52495),j=a.i(60246),k=a.i(70106);let l=(0,k.default)("Mic2",[["path",{d:"m12 8-9.04 9.06a2.82 2.82 0 1 0 3.98 3.98L16 12",key:"zoua8r"}],["circle",{cx:"17",cy:"7",r:"5",key:"1fomce"}]]);var m=a.i(3314),n=a.i(46654),o=a.i(30654),p=a.i(21374),q=a.i(50522),r=a.i(59165);let s=(0,k.default)("BarChart2",[["line",{x1:"18",x2:"18",y1:"20",y2:"10",key:"1xfpm4"}],["line",{x1:"12",x2:"12",y1:"20",y2:"4",key:"be30l9"}],["line",{x1:"6",x2:"6",y1:"20",y2:"14",key:"1r4le6"}]]);var t=a.i(95756),u=a.i(33508),v=a.i(92759);let w=(0,k.default)("Play",[["polygon",{points:"5 3 19 12 5 21 5 3",key:"191637"}]]);var x=a.i(46271),y=a.i(62036),z=a.i(72131),A=a.i(38246);let B=[{id:1,slug:"ellis-county-voter-guide-2026",title:"Ellis County Voter Guide 2026",description:"Full breakdown of every race and proposition on the Ellis County ballot — candidates, positions, and what each measure means for your community.",type:"PDF",category:"Voter Information",audience:["Voters"],featured:!0,downloads:342,tags:["Ellis County","2026 Election","Ballot Guide"],content:`## What's on the Ballot
...
If you don't know the answer: *"That's an important question and I want to give you an accurate answer — let me follow up with you directly. Can I get your contact information after?"*`}],C=[{label:"Voter Information",icon:n.Vote,description:"Registration deadlines, polling locations, ballot breakdowns, and rights.",audience:"Voters"},{label:"Candidate Toolkit",icon:r.Megaphone,description:"Campaign planning, filing requirements, FEC compliance, and messaging guides.",audience:"Candidates"},{label:"Media Relations",icon:o.Newspaper,description:"Press release templates, interview prep, and newsroom contact strategies.",audience:"All"},{label:"Public Speaking",icon:l,description:"Debate coaching, town hall facilitation, and speech structure frameworks.",audience:"All"},{label:"Civic Engagement",icon:j.Users,description:"Guides to attending public meetings, submitting comments, and organizing.",audience:"Voters"},{label:"Government Transparency",icon:m.Shield,description:"Open records requests, FOIA templates, and public accountability tools.",audience:"Voters"},{label:"Campaign Strategy",icon:s,description:"Polling interpretation, opposition research basics, and digital outreach.",audience:"Candidates"},{label:"Crisis & Reputation",icon:t.CheckCircle,description:"Rapid response playbooks, crisis messaging, and reputation management.",audience:"Candidates"}],D={All:"bg-cream/10 text-cream/80",Voters:"bg-blue-500/20 text-blue-300",Candidates:"bg-gold/20 text-gold"};function E({resource:a,onClose:c}){let[d,e]=(0,z.useState)(""),[g,h]=(0,z.useState)(!1),[i,j]=(0,z.useState)(!1),k=async b=>{if(b.preventDefault(),d){j(!0);try{let b=await fetch("/api/send-resource",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d,resourceTitle:a.title,resourceCategory:a.category,resourceType:a.type,resourceSlug:a.slug})});if(!b.ok){let a=await b.json().catch(()=>({}));throw console.error("send-resource error status:",b.status,"body:",a),Error(a.error||a.detail?.message||"Send failed")}h(!0)}catch(b){let a=b instanceof Error?b.message:"Unknown error";alert(`Something went wrong: ${a}`)}finally{j(!1)}}};return(0,b.jsxs)("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4",children:[(0,b.jsx)("div",{className:"absolute inset-0 bg-black/70 backdrop-blur-sm",onClick:c}),(0,b.jsxs)(x.motion.div,{initial:{opacity:0,scale:.95,y:10},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:10},transition:{duration:.2},className:"relative bg-navy border border-gold/30 rounded-2xl p-8 w-full max-w-md shadow-2xl",children:[(0,b.jsx)("button",{onClick:c,className:"absolute top-4 right-4 text-cream/40 hover:text-cream transition-colors",children:(0,b.jsx)(u.X,{className:"w-5 h-5"})}),g?(0,b.jsxs)("div",{className:"text-center py-4",children:[(0,b.jsx)("div",{className:"w-14 h-14 bg-green-500/15 border border-green-500/30 rounded-full flex items-center justify-center mx-auto mb-4",children:(0,b.jsx)(t.CheckCircle,{className:"w-7 h-7 text-green-400"})}),(0,b.jsx)("h3",{className:"font-display text-lg font-semibold text-white mb-2",children:"Check your inbox!"}),(0,b.jsxs)("p",{className:"text-cream/60 text-sm mb-4",children:["We sent a direct link to ",(0,b.jsx)("span",{className:"text-white",children:d}),"."]}),(0,b.jsx)(A.default,{href:`/resources/${a.slug}`,className:"btn-primary text-sm inline-block mb-3",onClick:c,children:"Read It Now →"}),(0,b.jsx)("br",{}),(0,b.jsx)("button",{onClick:c,className:"btn-secondary text-sm",children:"Back to Resources"})]}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)("div",{className:"w-12 h-12 bg-gold/10 border border-gold/30 rounded-xl flex items-center justify-center mb-4",children:"Video"===a.type?(0,b.jsx)(w,{className:"w-6 h-6 text-gold"}):(0,b.jsx)(f.Download,{className:"w-6 h-6 text-gold"})}),(0,b.jsx)("h3",{className:"font-display text-lg font-semibold text-white mb-1",children:"Video"===a.type?"Watch This Resource":"Get This Resource"}),(0,b.jsx)("p",{className:"text-gold/70 text-xs font-medium uppercase tracking-wide mb-2",children:a.category}),(0,b.jsxs)("p",{className:"text-cream/60 text-sm mb-6",children:[a.title," — enter your email and we'll send a direct link straight to your inbox."]}),(0,b.jsxs)("form",{onSubmit:k,className:"space-y-3",children:[(0,b.jsx)("input",{type:"email",required:!0,value:d,onChange:a=>e(a.target.value),placeholder:"your@email.com",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-3 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors"}),(0,b.jsx)("button",{type:"submit",disabled:i,className:"btn-primary w-full flex items-center justify-center gap-2",children:i?(0,b.jsx)("span",{className:"animate-pulse",children:"Sending…"}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(v.Send,{className:"w-4 h-4"})," Send to My Inbox"]})})]}),(0,b.jsx)("p",{className:"text-cream/30 text-xs text-center mt-4",children:"No spam. Unsubscribe anytime."})]})]})]})}function F({onClose:a}){let[c,d]=(0,z.useState)(""),[e,f]=(0,z.useState)(""),[g,h]=(0,z.useState)(""),[i,j]=(0,z.useState)(""),[k,l]=(0,z.useState)(""),[m,n]=(0,z.useState)(!1),[o,p]=(0,z.useState)(!1),q=async a=>{if(a.preventDefault(),e&&g&&i){p(!0);try{let a=await fetch("/api/submit-resource",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:c,email:e,title:g,description:i,link:k})});if(!a.ok){let b=await a.json().catch(()=>({}));throw console.error("submit-resource error status:",a.status,"body:",b),Error(b.error||"Submission failed")}n(!0)}catch(b){let a=b instanceof Error?b.message:"Unknown error";alert(`Something went wrong: ${a}`)}finally{p(!1)}}};return(0,b.jsxs)("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4",children:[(0,b.jsx)("div",{className:"absolute inset-0 bg-black/70 backdrop-blur-sm",onClick:a}),(0,b.jsxs)(x.motion.div,{initial:{opacity:0,scale:.95,y:10},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:10},transition:{duration:.2},className:"relative bg-navy border border-gold/30 rounded-2xl p-8 w-full max-w-lg shadow-2xl overflow-y-auto max-h-[90vh]",children:[(0,b.jsx)("button",{onClick:a,className:"absolute top-4 right-4 text-cream/40 hover:text-cream transition-colors",children:(0,b.jsx)(u.X,{className:"w-5 h-5"})}),m?(0,b.jsxs)("div",{className:"text-center py-6",children:[(0,b.jsx)("div",{className:"w-14 h-14 bg-green-500/15 border border-green-500/30 rounded-full flex items-center justify-center mx-auto mb-4",children:(0,b.jsx)(t.CheckCircle,{className:"w-7 h-7 text-green-400"})}),(0,b.jsx)("h3",{className:"font-display text-lg font-semibold text-white mb-2",children:"Thank you!"}),(0,b.jsx)("p",{className:"text-cream/60 text-sm mb-6",children:"Your resource suggestion has been submitted to the Pivotal Voice team. We will review it shortly."}),(0,b.jsx)("button",{onClick:a,className:"btn-primary text-sm",children:"Close"})]}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)("div",{className:"w-12 h-12 bg-gold/10 border border-gold/30 rounded-xl flex items-center justify-center mb-4",children:(0,b.jsx)(v.Send,{className:"w-6 h-6 text-gold"})}),(0,b.jsx)("h3",{className:"font-display text-lg font-semibold text-white mb-1",children:"Submit a Resource"}),(0,b.jsx)("p",{className:"text-cream/60 text-sm mb-6",children:"Share a guide, template, or tool with the Pivotal Voice community."}),(0,b.jsxs)("form",{onSubmit:q,className:"space-y-4",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-cream/80 text-xs font-semibold uppercase tracking-wider mb-1.5",children:"Your Name"}),(0,b.jsx)("input",{type:"text",value:c,onChange:a=>d(a.target.value),placeholder:"Jane Doe",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-2.5 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors"})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-cream/80 text-xs font-semibold uppercase tracking-wider mb-1.5",children:"Your Email *"}),(0,b.jsx)("input",{type:"email",required:!0,value:e,onChange:a=>f(a.target.value),placeholder:"your@email.com",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-2.5 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors"})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-cream/80 text-xs font-semibold uppercase tracking-wider mb-1.5",children:"Resource Title *"}),(0,b.jsx)("input",{type:"text",required:!0,value:g,onChange:a=>h(a.target.value),placeholder:"e.g. Ellis County Campaign Checklist",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-2.5 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors"})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-cream/80 text-xs font-semibold uppercase tracking-wider mb-1.5",children:"Link / Source URL (Optional)"}),(0,b.jsx)("input",{type:"url",value:k,onChange:a=>l(a.target.value),placeholder:"https://example.com/resource",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-2.5 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors"})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-cream/80 text-xs font-semibold uppercase tracking-wider mb-1.5",children:"Description / Content *"}),(0,b.jsx)("textarea",{required:!0,rows:4,value:i,onChange:a=>j(a.target.value),placeholder:"Describe the resource or paste its text here...",className:"w-full bg-navy-dark/60 border border-gold/20 rounded-lg px-4 py-2.5 text-white placeholder:text-cream/30 text-sm focus:outline-none focus:border-gold/50 transition-colors resize-none"})]}),(0,b.jsx)("button",{type:"submit",disabled:o,className:"btn-primary w-full flex items-center justify-center gap-2 mt-2",children:o?(0,b.jsx)("span",{className:"animate-pulse",children:"Submitting…"}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(v.Send,{className:"w-4 h-4"})," Submit for Review"]})})]})]})]})]})}function G(){let[a,j]=(0,z.useState)("All"),[k,l]=(0,z.useState)("All"),[m,n]=(0,z.useState)(null),[o,r]=(0,z.useState)(!1),s=B.filter(b=>{let c="All"===a||b.audience.includes(a)||b.audience.includes("All"),d="All"===k||b.category===k;return c&&d}),u=B.filter(a=>a.featured),v="All"===a?C:C.filter(b=>b.audience===a||"All"===b.audience),w=({resource:a,index:c})=>{var d;let e="Video"===(d=a.type)?h.Video:"Template"===d?g.FileText:"Checklist"===d?t.CheckCircle:g.FileText;return(0,b.jsxs)(x.motion.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.4,delay:Math.min(.05*c,.4)},className:"card group hover:border-gold/40 flex flex-col",children:[(0,b.jsxs)("div",{className:"flex items-start justify-between mb-3",children:[(0,b.jsx)("div",{className:"w-10 h-10 bg-gold/10 border border-gold/20 rounded-lg flex items-center justify-center",children:(0,b.jsx)(e,{className:"w-5 h-5 text-gold"})}),(0,b.jsx)("div",{className:"flex gap-1 flex-wrap justify-end",children:a.audience.filter(a=>"All"!==a).map(a=>(0,b.jsx)("span",{className:`text-xs px-2 py-0.5 rounded-full font-medium ${D[a]}`,children:a},a))})]}),(0,b.jsx)("span",{className:"text-gold/60 text-xs font-medium uppercase tracking-wide",children:a.category}),(0,b.jsx)(A.default,{href:`/resources/${a.slug}`,className:"mt-1 mb-2 flex-1",children:(0,b.jsx)("h3",{className:"font-display text-base font-semibold text-white group-hover:text-gold transition-colors leading-snug",children:a.title})}),(0,b.jsx)("p",{className:"text-cream/60 text-sm mb-4 line-clamp-3",children:a.description}),(0,b.jsx)("div",{className:"flex flex-wrap gap-1 mb-4",children:a.tags.slice(0,3).map(a=>(0,b.jsx)("span",{className:"text-xs bg-navy-dark/80 text-cream/40 px-2 py-0.5 rounded",children:a},a))}),(0,b.jsxs)("div",{className:"flex items-center justify-between pt-3 border-t border-gold/10 mt-auto",children:[(0,b.jsxs)("span",{className:"text-cream/40 text-xs",children:[a.downloads.toLocaleString()," downloads"]}),(0,b.jsxs)("button",{onClick:()=>n(a),className:"btn-secondary text-xs flex items-center gap-1.5 py-1.5 px-3",children:[(0,b.jsx)(f.Download,{className:"w-3.5 h-3.5"}),"Video"===a.type?"Watch":"Get"]})]})]},a.id)};return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsxs)(y.AnimatePresence,{children:[m&&(0,b.jsx)(E,{resource:m,onClose:()=>n(null)}),o&&(0,b.jsx)(F,{onClose:()=>r(!1)})]}),(0,b.jsx)(c.default,{}),(0,b.jsxs)("main",{className:"min-h-screen",children:[(0,b.jsxs)("section",{className:"relative bg-gradient-to-b from-navy via-navy to-navy-dark border-b border-gold/15 py-20 overflow-hidden",children:[(0,b.jsx)("div",{className:"absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(212,175,55,0.06)_0%,_transparent_60%)]"}),(0,b.jsx)("div",{className:"container-custom relative z-10",children:(0,b.jsxs)("div",{className:"text-center max-w-3xl mx-auto",children:[(0,b.jsx)("div",{className:"w-16 h-16 bg-gold/10 border border-gold/20 rounded-2xl flex items-center justify-center mx-auto mb-5",children:(0,b.jsx)(e.BookOpen,{className:"w-8 h-8 text-gold"})}),(0,b.jsx)("h1",{className:"text-hero font-bold text-white mb-4",children:"Resource Library"}),(0,b.jsx)("p",{className:"text-lg text-cream/60 mb-8",children:"Guides, templates, and tools built by political communications professionals — for voters who want to engage and candidates who want to win."}),(0,b.jsx)("div",{className:"inline-flex bg-navy-dark/60 border border-gold/20 rounded-xl p-1 gap-1",children:["All","Voters","Candidates"].map(c=>(0,b.jsx)("button",{onClick:()=>{j(c),l("All")},className:`px-5 py-2 rounded-lg text-sm font-semibold transition-all ${a===c?"bg-gold text-navy":"text-cream/60 hover:text-white"}`,children:"All"===c?"All Resources":`For ${c}`},c))})]})})]}),(0,b.jsx)("section",{className:"bg-navy-dark/80 border-b border-gold/10 py-6",children:(0,b.jsx)("div",{className:"container-custom",children:(0,b.jsxs)("div",{className:"grid grid-cols-3 gap-6 text-center",children:[(0,b.jsxs)("div",{children:[(0,b.jsxs)("div",{className:"text-2xl font-bold text-gold",children:[B.length,"+"]}),(0,b.jsx)("div",{className:"text-cream/50 text-sm mt-1",children:"Free Resources"})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("div",{className:"text-2xl font-bold text-gold",children:"8"}),(0,b.jsx)("div",{className:"text-cream/50 text-sm mt-1",children:"Categories"})]}),(0,b.jsxs)("div",{children:[(0,b.jsxs)("div",{className:"text-2xl font-bold text-gold",children:[B.reduce((a,b)=>a+b.downloads,0).toLocaleString(),"+"]}),(0,b.jsx)("div",{className:"text-cream/50 text-sm mt-1",children:"Total Downloads"})]})]})})}),"All"===a&&"All"===k&&(0,b.jsx)("section",{className:"section bg-navy-dark/30",children:(0,b.jsxs)("div",{className:"container-custom",children:[(0,b.jsxs)("div",{className:"flex items-center gap-3 mb-8",children:[(0,b.jsx)(p.Star,{className:"w-5 h-5 text-gold"}),(0,b.jsx)("h2",{className:"text-section font-bold text-white",children:"Featured Resources"})]}),(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:u.map((a,c)=>(0,b.jsx)(w,{resource:a,index:c},a.id))})]})}),(0,b.jsx)("section",{className:"section bg-navy-dark/50",children:(0,b.jsxs)("div",{className:"container-custom",children:[(0,b.jsx)("h2",{className:"text-section font-bold text-white mb-8",children:"Browse by Category"}),(0,b.jsxs)("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10",children:[(0,b.jsxs)(x.motion.button,{onClick:()=>l("All"),className:`card text-left group transition-all ${"All"===k?"border-gold/60 bg-gold/5":""}`,children:[(0,b.jsx)("h3",{className:`font-semibold transition-colors ${"All"===k?"text-gold":"text-white group-hover:text-gold"}`,children:"All Categories"}),(0,b.jsxs)("p",{className:"text-cream/40 text-xs mt-1",children:[s.length," resources"]})]}),v.map((c,d)=>{let e=c.icon,f=B.filter(b=>b.category===c.label&&("All"===a||b.audience.includes(a)||b.audience.includes("All"))).length;return(0,b.jsxs)(x.motion.button,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.4,delay:.04*d},onClick:()=>l(c.label),className:`card text-left group transition-all ${k===c.label?"border-gold/60 bg-gold/5":""}`,children:[(0,b.jsxs)("div",{className:"flex items-start gap-3",children:[(0,b.jsx)("div",{className:"w-8 h-8 bg-gold/10 rounded-lg flex items-center justify-center shrink-0 mt-0.5",children:(0,b.jsx)(e,{className:"w-4 h-4 text-gold"})}),(0,b.jsxs)("div",{children:[(0,b.jsx)("h3",{className:`font-semibold text-sm transition-colors ${k===c.label?"text-gold":"text-white group-hover:text-gold"}`,children:c.label}),(0,b.jsxs)("p",{className:"text-cream/40 text-xs mt-0.5",children:[f," resources"]})]})]}),(0,b.jsx)("p",{className:"text-cream/50 text-xs mt-3 leading-relaxed",children:c.description})]},c.label)})]})]})}),(0,b.jsx)("section",{className:"section",children:(0,b.jsxs)("div",{className:"container-custom",children:[(0,b.jsxs)("div",{className:"flex items-center justify-between mb-6",children:[(0,b.jsx)("h2",{className:"text-section font-bold text-white",children:"All"===k?"All Resources":k}),(0,b.jsxs)("span",{className:"text-cream/40 text-sm",children:[s.length," results"]})]}),0===s.length?(0,b.jsx)("div",{className:"text-center py-16 text-cream/40",children:"No resources found for this filter combination."}):(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6",children:s.map((a,c)=>(0,b.jsx)(w,{resource:a,index:c},a.id))})]})}),(0,b.jsx)("section",{className:"section bg-navy-dark/60 border-y border-gold/10",children:(0,b.jsx)("div",{className:"container-custom",children:(0,b.jsxs)("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-12 items-center",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("span",{className:"badge-gold text-xs mb-4 inline-block",children:"Pivotal Voice Services"}),(0,b.jsx)("h2",{className:"text-section font-bold text-white mb-4",children:"Need More Than a Template?"}),(0,b.jsx)("p",{className:"text-cream/70 mb-6",children:"These resources are a starting point. Pivotal Voice's communications professionals work directly with candidates and civic leaders — building custom messaging strategy, managing press relations, and guiding you through every stage of your campaign or issue."}),(0,b.jsx)("ul",{className:"space-y-3 mb-8",children:["Custom campaign messaging & brand development","Full-service media relations & press outreach","Crisis communications & reputation management","Debate prep & executive media coaching","Digital strategy & content production"].map(a=>(0,b.jsxs)("li",{className:"flex items-start gap-3 text-cream/80 text-sm",children:[(0,b.jsx)(q.ChevronRight,{className:"w-4 h-4 text-gold mt-0.5 shrink-0"}),a]},a))}),(0,b.jsxs)("div",{className:"flex gap-4",children:[(0,b.jsx)(A.default,{href:"/services#book",className:"btn-primary inline-flex items-center justify-center",children:"Schedule a Consultation"}),(0,b.jsxs)(A.default,{href:"/services",className:"btn-secondary inline-flex items-center gap-2",children:[(0,b.jsx)(i.ExternalLink,{className:"w-4 h-4"}),"View Services"]})]})]}),(0,b.jsx)("div",{className:"grid grid-cols-2 gap-4",children:[{label:"Campaigns Supported",value:"50+"},{label:"Media Placements",value:"300+"},{label:"Years in Ellis County",value:"12+"},{label:"Candidate Win Rate",value:"74%"}].map(a=>(0,b.jsxs)("div",{className:"card text-center",children:[(0,b.jsx)("div",{className:"text-3xl font-bold text-gold mb-1",children:a.value}),(0,b.jsx)("div",{className:"text-cream/50 text-sm",children:a.label})]},a.label))})]})})}),(0,b.jsx)("section",{className:"bg-navy py-16",children:(0,b.jsx)("div",{className:"container-custom",children:(0,b.jsxs)("div",{className:"text-center max-w-2xl mx-auto",children:[(0,b.jsx)("h2",{className:"text-section font-bold text-white mb-4",children:"Share a Resource"}),(0,b.jsx)("p",{className:"text-cream/70 mb-6",children:"Have a guide, template, or tool that would help Ellis County voters or candidates? Submit it for review and we'll add it to the library."}),(0,b.jsx)("button",{onClick:()=>r(!0),className:"btn-primary",children:"Submit a Resource"})]})})})]}),(0,b.jsx)(d.default,{})]})}a.s(["default",()=>G],42714)}];
