module.exports=[93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},10044,e=>{"use strict";var t=e.i(47909),r=e.i(74017),o=e.i(96250),a=e.i(59756),n=e.i(61916),i=e.i(74677),s=e.i(69741),d=e.i(16795),l=e.i(87718),p=e.i(95169),c=e.i(47587),u=e.i(66012),f=e.i(70101),g=e.i(26937),x=e.i(10372),h=e.i(93695);e.i(52474);var m=e.i(5232),b=e.i(46245),v=e.i(89171);async function w(e){try{let{name:t,email:r,phone:o,subject:a,message:n,nomineeName:i,nomineeBio:s,nomineeContact:d}=await e.json(),l="Nominate someone to be on the show"===a;if(!t||!r||!a||!l&&!n)return v.NextResponse.json({error:"Missing required fields"},{status:400});if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(r))return v.NextResponse.json({error:"Invalid email address"},{status:400});if(l&&(!i||!s||!d))return v.NextResponse.json({error:"Missing required nominee fields (Name, Bio, and Contact Info are required)"},{status:400});let p=process.env.RESEND_API_KEY;if(!p)return console.error("RESEND_API_KEY is not set"),v.NextResponse.json({error:"Email service not configured"},{status:500});let c=new b.Resend(p),u=`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="utf-8">
                    ...
                    <td style="padding:36px 40px;color:rgba(245,235,210,0.85);font-size:15px;line-height:1.6;">
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;border-collapse:collapse;">
                        ...
                        <tr>
                          ...
                          <td style="padding:6px 0;color:#ffffff;">${d||"Not provided"}</td>
                        </tr>
                      </table>
                      `:""}
                      ...
                      <h2 style="color:#d4af37;font-size:16px;font-weight:600;margin:28px 0 12px;border-bottom:1px solid rgba(212,175,55,0.1);padding-bottom:6px;">
                        ${l?"Additional Notes":"Message Body"}
                      </h2>
                      <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.05);border-radius:8px;padding:16px;color:#ffffff;white-space:pre-wrap;margin-bottom:24px;">${n||'<em style="color:rgba(245,235,210,0.4);">None provided</em>'}</div>
