export type Audience = 'All' | 'Voters' | 'Candidates';
export type ResourceType = 'PDF' | 'Video' | 'Guide' | 'Template' | 'Checklist';
...
export interface Resource {
    ...
    downloads: number;
    tags: string[];
    content: string; // full body shown on the resource detail page
}
